        ...
        *,
        ...
        return "\n".join(
            [
                ...
                f"Delivery style: {answer_plan.delivery_style if answer_plan else 'spoken_balanced'}",
                f"Opening move: {answer_plan.opening_move if answer_plan else 'answer_first'}",
                f"Closing move: {answer_plan.closing_move if answer_plan else 'boundary_first'}",
